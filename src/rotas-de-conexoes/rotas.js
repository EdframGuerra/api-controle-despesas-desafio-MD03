...
const { cadastroUsuario, login, detalharUsuario, atualizacaoCadastro, listarCategoias, cadastrarTransacao } = require('../controladores-de-rotas/controladorUsuarios')
...
rotas.get('/categoria', listarCategoias)
