...
const { cadastroUsuario, login, detalharUsuario, atualizacaoCadastro, listarCategorias, cadastrarTransacao, listarTransacoesUsuario } = require('../controladores-de-rotas/controladorUsuarios')
